...
#####My Question: What is the realtionship between the maximum number of traffic deaths for every 20,000 people? 
This map_dbl function is calculating the maximum value of each column in my 'jazz_traffic' dataset which represents the maximum number of traffic deaths per 20,000 people per country in years 2002 and 2004.
...
Jazz_data <- jazz1 %>%
  mutate(Ratio1.2002 = `2002.trafficDeath` / `2002.popDensity`, 
         Ratio1.2004 = `2004.trafficDeath` / `2004.popDensity`)

#higher the ratio, the higher percentage of greater than 3 traffic deaths relative to the population density per 20,000 people
...
results <- Jazz_perm(1000,combined_data)
